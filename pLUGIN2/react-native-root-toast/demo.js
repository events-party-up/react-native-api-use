...
//   toast = null;
  ...
  show = () => {
      console.log('show ：', )
      const message = messages[~~(messages.length * Math.random())];
  ...
  render() {
    ...
    console.log('code 组件 this.state, this.props ：', this.state, this.props, code)
    return (
      <ScrollView
