...
export default class CircleButton extends Component {
  ...
  createAnimation = (obj, toValue, duration, easing) => {
    console.log('createAnimation ：', obj, toValue, duration, easing)
  ...
  _buttonBottom = () => {
    console.log('_buttonBottom ：', )
    this.setState({isClicked: !this.state.isClicked});
    this.endAnimation();
    this.props.onPressButtonBottom();
  }
  _buttonLeft = () => {
    console.log('_buttonLeft ：', )
    this.setState({isClicked: !this.state.isClicked});
    this.endAnimation();
  ...
  render() {
    ...
    console.log(' 组件 this.state, this.props ：', this.state, this.props, )
