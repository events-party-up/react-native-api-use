...
export default class App extends Component {
  ...
  _createRandomRows(data) {
    console.log('_createRandomRows ：', data)
  ...
  _createRandomData(data) {
    console.log('_createRandomData ：', data)
    return {
  ...
  _createRandomDataSource(data) {
    console.log('_createRandomDataSource ：', data)
  ...
  _itemCountChanged(itemCount) {
    console.log('_itemCountChanged ：', itemCount, )
  ...
  _itemsPerRowChanged(itemsPerRow) {
    console.log('_itemsPerRowChanged ：', itemsPerRow)
    clearTimeout(this._renderTimeout);
    this._renderTimeout = setTimeout(() => {
  ...
  _useRandomCountsChanged(useRandomCounts) {
    console.log('_useRandomCountsChanged ：', useRandomCounts)
...
function generateData(itemCount) {
  console.log('generateData ：', itemCount)
