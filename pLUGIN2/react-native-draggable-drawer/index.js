...
const DraggableDrawer = require('react-native-draggable-drawer');

export default class DraggableDrawerDemo extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  onDragDown = ( drawerPosition ) => { 
    console.log('onDragDown ：', drawerPosition, this.state)
  ...
  render() {
    console.log('DraggableDrawerDemo 组件 this.state, this.props ：', this.state, this.props, )
