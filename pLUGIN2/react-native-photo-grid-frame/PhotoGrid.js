...
export default class PhotoGrid extends Component {
    ...
    photoPopupToggle(photoUrl) {
        console.log('photoPopupToggle ：', photoUrl)
    ...
    renderPhotoRow(rowItem, rowIndex) {
        console.log('renderPhotoRow ：', rowItem, rowIndex)
        if (rowIndex == 0) {
    ...
    renderPhotoRow2(row) {
        console.log('renderPhotoRow2 ：', row)
        if (row.length == 1) {
            return (
    ...
    renderPhotoRow3(row) {
        console.log('renderPhotoRow3 ：', row)
        if (row.length == 1) {
            return (
                <View key={row[0].url} style={styles.alignCenter}>
    ...
    render() {
        console.log('PhotoGrid 组件 this.state, this.props ：', this.state, this.props, )
        return (
