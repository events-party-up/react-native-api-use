...
const itemsAnimationAndSeparator = Array.from(Array(5)).map((_, index) =>image(index),);
...
export default class App extends PureComponent {
  renderItemAnimationAndSeparator = ({ item, animation }) => {
    console.log('renderItemAnimationAndSeparator ：', item, animation)
    return (
      <Image
  ...
  renderItemAnimation = ({ item, animation }) => {
    console.log('renderItemAnimation ：', item, animation)
    return (
      <Image
        style={styles.image}
        source={item.thumbnail}
  ...
  render() {
    console.log('App 组件 this.state, this.props ：', this.state, this.props, itemsAnimationAndSeparator, itemsAnimation, itemsSeparator, )
    return (
