...
export default class SwipeableExample extends Component {
  ...
  handleScroll = () => {
    console.log('handleScroll this.state, this.props ：', this.state, this.props, )
  ...
  render() {
    ...
    console.log('SwipeableExample 组件 this.state, this.props ：', this.state, this.props, itemProps, )
...
function Example1({onOpen, onClose}) {
  console.log('Example1 ：', onOpen, onClose)
  return (
    <Swipeable
      leftContent={(
...
function Example2({onOpen, onClose}) {
  console.log('Example2 组件 this.state, this.props ：', this.state, this.props, )
  return (
    <Swipeable
      leftButtonWidth={45}
      leftButtons={[
...
class Example3 extends Component {
  ...
  render() {
    ...
    console.log('Example3 组件 this.state, this.props ：', this.state, this.props, )
    return (
      <Swipeable
