...
export default class PullDemo extends Component {
    ...
    onPullRelease(resolve) {
        console.log('onPullRelease ：', resolve)
		//do something
		setTimeout(() => {
            resolve();
        }, 3000);
	...
	topIndicatorRender(pulling, pullok, pullrelease) {
        console.log('topIndicatorRender ：', pulling, pullok, pullrelease)
    ...
    render() {
        console.log('PullDemo 组件 this.state, this.props ：', this.state, this.props, )
        return (
    ...
    renderRow(item, sectionID, rowID, highlightRow) {
        console.log('renderRow ：', item, sectionID, rowID, highlightRow)
        return (
