...
export default class sampleApp extends Component {
  ...
  renderSuggestionsRow({ item }, hidePanel) {
    console.log('renderSuggestionsRow ：', item, hidePanel )
    return (
  ...
  onSuggestionTap(username, hidePanel) {
    console.log('onSuggestionTap ：', username, hidePanel )
    hidePanel();
  ...
  callback(keyword) {
    console.log('callback this.state, this.props ：', this.state, this.props, keyword)
    if (this.reqTimer) {
