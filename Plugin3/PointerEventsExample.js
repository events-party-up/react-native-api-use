...
class ExampleBox extends React.Component {
  ...
  handleLog = (msg) => {
    console.log('handleLog ：', msg, this.state)
  ...
  render() {
    ...
    return (
      <ScrollView style={styles.container}>
        <Text style={styles.text}>无触摸 none</Text>
        <NoneExample></NoneExample>

        <Text style={styles.text}>盒子没有效果 box-none</Text>
        <BoxNoneExample></BoxNoneExample>

        <Text style={styles.text}>仅仅盒子触摸 box-only</Text>
