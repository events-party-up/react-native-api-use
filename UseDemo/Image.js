...
class NetworkImageCallbackExample extends React.Component {
  ...
  componentWillMount() {
    console.log('组件挂载 组件 this.state, this.props ：', this.state, this.props, )
    this.setState({mountTime: new Date()});
  }
  _loadEventFired = (event) => {
    console.log('_loadEventFired ：', event)
    this.setState((state) => {
      return state.events = [...state.events, event];
    });
  }
  render() {
    console.log('NetworkImageCallbackExample 组件 this.state, this.props ：', this.state, this.props, )
...
class NetworkImageExample extends React.Component {
  ...
  render() {
    console.log('NetworkImageExample 组件 this.state, this.props ：', this.state, this.props, )
...
class ImageSizeExample extends React.Component {
  ...
  componentDidMount() {
    console.log('ImageSizeExample 组件 this.state, this.props ：', this.state, this.props, )
...
class MultipleSourcesExample extends React.Component {
  ...
  increaseImageSize = () => {
    console.log('increaseImageSize ：', this.state)
  ...
  decreaseImageSize = () => {
    console.log('decreaseImageSize ：', this.state)
...
const smallImage = {uri: 'https://facebook.github.io/react/img/logo_small_2x.png'};
