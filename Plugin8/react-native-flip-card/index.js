...
export default class FlipCardExample extends Component {
  ...
  render() {
    console.log('FlipCardExample 组件 this.state, this.props ：', this.state, this.props, )
    return (
...
export default class MyFlipCard extends Component {
  shouldComponentUpdate (nextProps, nextState) {
    return false
  },
  render () {
    console.log('MyFlipCard 组件 this.state, this.props ：', this.state, this.props, )
    return (
      <View style={{margin: 3}}>
        <FlipCard
          style={styles.card}
