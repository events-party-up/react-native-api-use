...
export default class AnExBobble extends React.Component {
  ...
  render() {
    console.log('AnExBobble 组件 this.state, this.props ：', RAD_EACH, BOBBLE_SPOTS, this.state, this.props, )
    return (
...
function computeNewSelected(gestureState) {
  console.log('computeNewSelected ：', gestureState)
