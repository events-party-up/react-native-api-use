...
export default class AnExScroll extends React.Component {
  state = { 
  ...
  render() {
    ...
    console.log('AnExScroll 组件 this.state, this.props ：', width, this.state, this.props, )
    return (
        ...
        <ScrollView
          ...
          <View style={[styles.page, {width}]}>
            ...
            <Text style={styles.text}>
              {'我会找到一些东西放到这里I\'ll find something to put here.'}
            </Text>
          </View>
          <View style={[styles.page, {width}]}>
